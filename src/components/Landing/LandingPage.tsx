    ...
    <div className="min-h-screen bg-[#0d1117] text-[#c9d1d9] font-sans selection:bg-orca-accent/30 selection:text-white">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-md bg-[#0d1117]/85 border-b border-[#30363d] px-6 py-3 flex items-center justify-between">
        <div className="flex items-center space-x-3 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-[10px] bg-[#21262d] text-[#58a6ff] border border-[#30363d] px-1.5 py-0.5 rounded font-mono font-medium">v1.0</span>
          </div>
        </div>
        ...
        <div className="hidden md:flex items-center space-x-6 text-sm text-[#8b949e]">
          ...
          <a href="#comparison" className="hover:text-white transition-colors">痛点对比</a>
          <a href="#shortcuts" className="hover:text-white transition-colors">快捷键</a>
          <a href="#quickstart" className="hover:text-white transition-colors">快速运行</a>
          <a href="https://github.com/sheilacraig/MonoTerminal/blob/main/docs/PACKAGING.md" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">
            打包指南
          </a>
        </div>
      ...
      <section className="relative overflow-hidden pt-20 pb-16 px-6 max-w-6xl mx-auto text-center">
        ...
        <p className="max-w-2xl mx-auto text-base sm:text-lg text-[#8b949e] leading-relaxed mb-10">
          告别在黑色终端、浏览器大模型与 SFTP 软件之间反复复制粘贴。报错自动感知，单键切换 AI 诊断，一键回车落地执行，配置文件在线同步写回。
        </p>
        ...
        <div className="relative mx-auto rounded-xl border border-[#30363d] bg-[#161b22] shadow-2xl overflow-hidden text-left font-mono">
          ...
          <div className="bg-[#0d1117] border-b border-[#30363d] px-4 py-2 flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="ml-2 text-xs text-[#8b949e] font-sans font-medium">MonoTerminal - prod-web01 (root@10.0.0.12)</span>
            </div>
            <div className="flex items-center space-x-2 text-xs text-[#8b949e]">
              <span className="bg-[#21262d] px-2 py-0.5 rounded text-[11px] text-[#58a6ff]">Ctrl + \ 穿梭模式</span>
              <span className="bg-[#21262d] px-2 py-0.5 rounded text-[11px] text-[#3fb950]">RTT: 12ms</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 h-[420px] bg-[#0d1117] text-xs">
            ...
            <div className="hidden md:block md:col-span-3 border-r border-[#30363d] bg-[#161b22]/70 p-3 overflow-hidden">
              ...
              <div className="space-y-1.5 text-[11px] text-[#8b949e]">
                ...
                <div className="pl-3 text-yellow-400 flex items-center space-x-1"><span>📁</span> <span>conf.d/</span></div>
                <div className="pl-3 text-yellow-400 flex items-center space-x-1"><span>📁</span> <span>ssl/</span></div>
            ...
            <div className="col-span-1 md:col-span-9 grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-[#30363d]">
              ...
              <div className="p-4 flex flex-col justify-between bg-[#0d1117] overflow-hidden">
                <div className="space-y-1.5 leading-relaxed text-[#c9d1d9]">
                  ...
                  <div className="text-[#8b949e]">root@prod-web01:~# tail -n 2 /var/log/nginx/error.log</div>
                  <div className="text-red-400 bg-red-950/30 p-1.5 rounded border border-red-900/50">
                    2026/09/20 18:42:12 [emerg] 1042#1042: bind() to 0.0.0.0:80 failed (98: Address already in use)
                  </div>
              ...
              <div className="p-4 flex flex-col justify-between bg-[#161b22]/50">
                <div className="space-y-3">
                  ...
                  <div className="text-[11px] text-[#8b949e] font-sans leading-relaxed">
                    诊断结论：80 端口已被外部进程占用，导致 Nginx 无法完成 bind() 绑定。建议排查占用进程并释放端口。
                  </div>
                ...
                <div className="text-[10px] text-[#8b949e] font-sans text-right pt-2 border-t border-[#30363d]">
                  按 <kbd className="text-white bg-[#21262d] px-1 py-0.5 rounded">Ctrl + \</kbd> 随时切回终端
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="comparison" className="py-20 px-6 max-w-6xl mx-auto border-t border-[#30363d]">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">为什么需要 MonoTerminal？</h2>
          ...
          <div className="bg-[#161b22]/50 border border-red-900/30 rounded-xl p-6 relative overflow-hidden">
            ...
            <ul className="space-y-4 text-sm text-[#8b949e]">
              <li className="flex items-start space-x-3">
                ...
                <span><strong>手动复制大段日志</strong>：终端出现报错，只能手动滚动、鼠标框选，频繁切换到网页端大模型提问。</span>
              </li>
              <li className="flex items-start space-x-3">
                <span className="text-red-400 font-bold shrink-0">2.</span>
                <span><strong>命令复制易出错</strong>：复制大模型给出的建议命令切回终端，手动粘贴，容易漏改关键参数。</span>
              </li>
              <li className="flex items-start space-x-3">
                <span className="text-red-400 font-bold shrink-0">3.</span>
                <span><strong>远程改配置繁琐</strong>：修改 nginx.conf 或配置文件，要么忍受 vim/nano 的别扭快捷键，要么得另开繁重的 SFTP 客户端。</span>
              </li>
              <li className="flex items-start space-x-3">
                <span className="text-red-400 font-bold shrink-0">4.</span>
                <span><strong>强制登录与隐私顾虑</strong>：许多工具要求微信扫码、手机号注册，甚至把服务器账密和日志上传到云端同步。</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-[#161b22] border border-emerald-500/30 rounded-xl p-6 relative overflow-hidden shadow-lg shadow-emerald-950/20">
            ...
            <ul className="space-y-4 text-sm text-[#c9d1d9]">
              <li className="flex items-start space-x-3">
                ...
                <span><strong>报错自动感知 + 一键穿梭</strong>：持续监听终端输出流，按 <kbd className="text-white bg-[#21262d] px-1 py-0.5 rounded text-xs">Ctrl + \</kbd> 瞬间带入最近 50 行报错直接开始诊断。</span>
              </li>
              <li className="flex items-start space-x-3">
                <span className="text-emerald-400 font-bold shrink-0">2.</span>
                <span><strong>回车直接运行命令</strong>：AI 给出的排错指令化作可交互卡片，按回车直接在终端中落地执行并切回终端。</span>
              </li>
              <li className="flex items-start space-x-3">
                <span className="text-emerald-400 font-bold shrink-0">3.</span>
                <span><strong>集成 SFTP 与在线编辑器</strong>：左侧树形浏览远程文件，点击文件直接在线修改，按 <kbd className="text-white bg-[#21262d] px-1 py-0.5 rounded text-xs">Ctrl + S</kbd> 实时写回远程。</span>
              </li>
              <li className="flex items-start space-x-3">
                <span className="text-emerald-400 font-bold shrink-0">4.</span>
                <span><strong>100% 零登录与本地加密</strong>：无账号体系，密码与 API Key 本地 AES-256-GCM 硬件派生加密，支持 Ollama 离线模型。</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <section id="features" className="py-20 px-6 max-w-6xl mx-auto border-t border-[#30363d]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-[#161b22] border border-[#30363d] hover:border-[#58a6ff]/50 rounded-xl p-6 transition-all group">
            ...
            <h3 className="text-white font-semibold text-base mb-2">零登录，本地优先 (Local-First)</h3>
            <p className="text-sm text-[#8b949e] leading-relaxed">
              无登录注册，无手机号绑定。所有服务器资产凭证与 API Key 均在本地通过机器特征派生密钥的 <strong>AES-256-GCM</strong> 硬件级本地加密。
            </p>
          </div>
          ...
          <div className="bg-[#161b22] border border-[#30363d] hover:border-purple-500/50 rounded-xl p-6 transition-all group">
            ...
            <p className="text-sm text-[#8b949e] leading-relaxed">
              双图层 DOM 缓存架构，按 <kbd className="text-white bg-[#21262d] px-1 py-0.5 rounded text-xs">Ctrl + \</kbd> 毫秒级瞬切终端与 AI 助手，后台 SSH 会话长连接保活不中断。
            </p>
          </div>
          ...
          <div className="bg-[#161b22] border border-[#30363d] hover:border-emerald-500/50 rounded-xl p-6 transition-all group">
            ...
            <p className="text-sm text-[#8b949e] leading-relaxed">
              左栏远程文件树支持自由拖拽调节宽度、按 <kbd className="text-white bg-[#21262d] px-1 py-0.5 rounded text-xs">Ctrl + B</kbd> 极速收起；内置代码编辑器，按 <kbd className="text-white bg-[#21262d] px-1 py-0.5 rounded text-xs">Ctrl + S</kbd> 实时写回。
            </p>
          </div>
          ...
          <div className="bg-[#161b22] border border-[#30363d] hover:border-amber-500/50 rounded-xl p-6 transition-all group">
            ...
            <h3 className="text-white font-semibold text-base mb-2">Ollama 离线与自由接入 (BYOK)</h3>
            <p className="text-sm text-[#8b949e] leading-relaxed">
              原生支持 <strong>Ollama 本地大模型直连</strong>，全内网离线秒通；同时支持 DeepSeek 官方 API、OpenAI、Claude、通义千问等自带 Key 接入。
            </p>
          </div>
          ...
          <div className="bg-[#161b22] border border-[#30363d] hover:border-red-500/50 rounded-xl p-6 transition-all group">
            ...
            <h3 className="text-white font-semibold text-base mb-2">危险命令安全门禁 (Guardrail)</h3>
            <p className="text-sm text-[#8b949e] leading-relaxed">
              内置安全拦截层，精准拦截 <code>rm -rf /</code>、<code>mkfs</code>、<code>dd</code> 等破坏性操作，必须强制手动确认或按 <kbd className="text-white bg-[#21262d] px-1 py-0.5 rounded text-xs">Alt + Y</kbd> 放行。
            </p>
          </div>
          ...
          <div className="bg-[#161b22] border border-[#30363d] hover:border-teal-500/50 rounded-xl p-6 transition-all group">
            ...
            <p className="text-sm text-[#8b949e] leading-relaxed">
              无需预先准备云服务器或复杂网络，内置仿真 Linux 运维沙盒与 Nginx 典型故障场景，打开即可立刻体验完整的排障闭环。
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="shortcuts" className="py-20 px-6 max-w-6xl mx-auto border-t border-[#30363d]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 font-mono">
          <div className="bg-[#161b22] border border-[#30363d] p-4 rounded-lg">
            ...
            <div className="text-xs text-[#c9d1d9] font-sans font-medium mb-1">瞬切 Shell / Agent</div>
            <div className="text-[11px] text-[#8b949e] font-sans">自动提取终端最近 50 行输出作为排查背景</div>
          </div>

          <div className="bg-[#161b22] border border-[#30363d] p-4 rounded-lg">
            <div className="text-sm font-bold text-emerald-400 mb-1">Enter</div>
            <div className="text-xs text-[#c9d1d9] font-sans font-medium mb-1">一键执行建议命令</div>
            <div className="text-[11px] text-[#8b949e] font-sans">选中命令卡片敲回车，命令即刻在终端执行</div>
          </div>
          ...
          <div className="bg-[#161b22] border border-[#30363d] p-4 rounded-lg">
            ...
            <div className="text-[11px] text-[#8b949e] font-sans">将建议命令追加到当前提示符后等待修改</div>
          </div>

          <div className="bg-[#161b22] border border-[#30363d] p-4 rounded-lg">
            <div className="text-sm font-bold text-purple-400 mb-1">Ctrl + B</div>
            <div className="text-xs text-[#c9d1d9] font-sans font-medium mb-1">折叠 / 展开侧边栏</div>
            <div className="text-[11px] text-[#8b949e] font-sans">收起左侧 SFTP 树，主视窗空间扩展至 98%+</div>
          </div>

          <div className="bg-[#161b22] border border-[#30363d] p-4 rounded-lg">
            <div className="text-sm font-bold text-[#c9d1d9] mb-1">Ctrl + S</div>
            <div className="text-xs text-[#c9d1d9] font-sans font-medium mb-1">在线保存远程文件</div>
            <div className="text-[11px] text-[#8b949e] font-sans">在 SFTP 在线代码编辑器中即时写回服务器</div>
          </div>
          ...
          <div className="bg-[#161b22] border border-[#30363d] p-4 rounded-lg">
            ...
            <div className="text-[11px] text-[#8b949e] font-sans">顶部新增连接标签页，呼出主机列表</div>
          </div>
          ...
          <div className="bg-[#161b22] border border-[#30363d] p-4 rounded-lg">
            ...
            <div className="text-[11px] text-[#8b949e] font-sans">安全关闭当前 Tab 并断开后台连接</div>
          </div>

          <div className="bg-[#161b22] border border-[#30363d] p-4 rounded-lg">
            <div className="text-sm font-bold text-red-400 mb-1">Alt + Y</div>
            <div className="text-xs text-[#c9d1d9] font-sans font-medium mb-1">高危命令强制确认</div>
            <div className="text-[11px] text-[#8b949e] font-sans">在拦截弹窗中直接放行高危命令执行</div>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 font-mono text-xs">
          ...
          <div className="bg-[#161b22] border border-[#30363d] p-5 rounded-xl space-y-3">
            <div className="flex items-center justify-between text-[#c9d1d9] font-sans font-semibold pb-2 border-b border-[#30363d]">
              ...
              <span className="text-[11px] text-emerald-400 bg-emerald-950/60 px-2 py-0.5 rounded">推荐</span>
            </div>
            ...
            <div className="bg-[#0d1117] p-3 rounded-lg text-[#58a6ff] space-y-1 overflow-x-auto">
              <div><span className="text-[#8b949e]"># 克隆并安装依赖</span></div>
              <div>git clone https://github.com/sheilacraig/MonoTerminal.git</div>
              <div>cd MonoTerminal</div>
              <div>npm install</div>
              <div className="pt-2"><span className="text-[#8b949e]"># 构建前端产物并启动服务</span></div>
              <div>npm run build</div>
              <div>npm start</div>
            </div>
            <div className="text-[11px] text-[#8b949e] font-sans">
              启动后在浏览器访问 <code className="text-white bg-[#0d1117] px-1 py-0.5 rounded">http://localhost:3001</code> 即可使用。
            </div>
          </div>
          ...
          <div className="bg-[#161b22] border border-[#30363d] p-5 rounded-xl space-y-3">
            <div className="flex items-center justify-between text-[#c9d1d9] font-sans font-semibold pb-2 border-b border-[#30363d]">
              ...
              <span className="text-[11px] text-blue-400 bg-blue-950/60 px-2 py-0.5 rounded">桌面端</span>
            </div>
            <div className="text-[#8b949e] font-sans text-xs">
              通过 Electron 外壳运行为原生桌面应用窗口，或打包为单文件 Windows <code>.exe</code>：
            </div>
            <div className="bg-[#0d1117] p-3 rounded-lg text-[#58a6ff] space-y-1 overflow-x-auto">
              <div><span className="text-[#8b949e]"># 安装 Electron 依赖</span></div>
              <div>npm install --save-dev electron</div>
              <div className="pt-2"><span className="text-[#8b949e]"># 启动桌面端原生外壳</span></div>
              <div>npm run electron</div>
            </div>
            <div className="text-[11px] text-[#8b949e] font-sans">
              完整单文件 .exe 打包及 Windows 安装包指南：请参阅 <a href="https://github.com/sheilacraig/MonoTerminal/blob/main/docs/PACKAGING.md" target="_blank" rel="noreferrer" className="text-blue-400 hover:underline">PACKAGING.md</a>。
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 max-w-4xl mx-auto text-center border-t border-[#30363d]">
        <div className="bg-gradient-to-b from-[#161b22] to-[#0d1117] border border-[#30363d] rounded-2xl p-10 relative overflow-hidden shadow-2xl">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">准备好升级你的终端排障体验了吗？</h2>
          <p className="text-sm text-[#8b949e] max-w-lg mx-auto mb-8">
            无需安装任何云服务或数据库，100% 本地优先与加密。现在即可进入在线演示 Demo，或克隆到本地直接运行。
          </p>
      ...
      <footer className="border-t border-[#30363d] py-8 px-6 text-center text-xs text-[#8b949e]">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-4">
            <a href="https://github.com/sheilacraig/MonoTerminal" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">
              GitHub 仓库
            </a>
            <a href="https://github.com/sheilacraig/MonoTerminal/blob/main/LICENSE" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">
              MIT License
            </a>
